    ...
    switch (arch) {
      case 'x64':
        if (existsSync(join(currentDir, '../npm/win32-x64-msvc/index.farm'))) {
          ...
          binPath = require.resolve('farm-plugin-aoike-win32-x64-msvc');
        }
      ...
      case 'ia32':
        if (existsSync(join(currentDir, '../npm/win32-ia32-msvc/index.farm'))) {
          ...
          binPath = require.resolve('farm-plugin-aoike-win32-ia32-msvc');
        }
      ...
      case 'arm64':
        if (existsSync(join(currentDir, '../npm/win32-arm64-msvc/index.farm'))) {
          ...
          binPath = require.resolve('farm-plugin-aoike-win32-arm64-msvc');
        }
    ...
    switch (arch) {
      case 'x64':
        if (existsSync(join(currentDir, '../npm/darwin-x64/index.farm'))) {
          ...
          binPath = require.resolve('farm-plugin-aoike-darwin-x64');
        }
        break;
      case 'arm64':
        if (existsSync(join(currentDir, '../npm/darwin-arm64/index.farm'))) {
          ...
          binPath = require.resolve('farm-plugin-aoike-darwin-arm64');
        }
        break;
      default:
      ...
      case 'x64':
        if (isMusl()) {
          if (existsSync(join(currentDir, '../npm/linux-x64-musl/index.farm'))) {
            ...
            binPath = require.resolve('farm-plugin-aoike-linux-x64-musl');
          }
        } else {
          if (existsSync(join(currentDir, '../npm/linux-x64-gnu/index.farm'))) {
            binPath = join(currentDir, '../npm/linux-x64-gnu/index.farm');
          } else {
            binPath = require.resolve('farm-plugin-aoike-linux-x64-gnu');
          }
        }
      ...
      case 'arm64':
        if (isMusl()) {
          if (
            ...
            binPath = require.resolve('farm-plugin-aoike-linux-arm64-musl');
          }
        } else {
          if (
            ...
            binPath = require.resolve('farm-plugin-aoike-linux-arm64-gnu');
          }
        }
        break;
      default:
